...
// import { Search, Code, BookOpen, Clock, TrendingUp } from 'lucide-react';
...
//                     className="flex-1 py-4 px-2 text-lg placeholder-gray-400 border-none outline-none bg-transparent"
//                   />
//                   <button
//                     onClick={searchProblems}
//                     disabled={isLoading || !query.trim()}
//                     className="flex-shrink-0 bg-gradient-to-r from-blue-500 to-purple-600 text-white px-8 py-3 rounded-xl font-semibold hover:from-blue-600 hover:to-purple-700 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl"
//                   >
//                     {isLoading ? (
...
//             <p className="text-center text-gray-500 mb-4">Popular topics:</p>
//             <div className="flex flex-wrap justify-center gap-2">
//               {['Arrays', 'Linked Lists', 'Trees', 'Graphs', 'Dynamic Programming', 'Sorting', 'Binary Search', 'Recursion'].map((topic) => (
//                 <button
//                   key={topic}
//                   onClick={() => setQuery(topic.toLowerCase())}
//                   className="px-4 py-2 bg-white rounded-full text-sm font-medium text-gray-700 border border-gray-200 hover:border-blue-300 hover:bg-blue-50 transition-all duration-200 hover:shadow-sm"
//                 >
//                   {topic}
//                 </button>
//               ))}
